...
fs.createReadStream('utf.txt','utf8').pipe(cfs.decodeStream('utf8')).pipe(process.stdout);
fs.createReadStream('gbk.txt').pipe(cfs.decodeStream('gbk')).pipe(process.stdout);
/*
